...
to the [latest release](https://marketplace.upbound.io/providers/daanvinken/provider-consul):
```
up ctp provider install daanvinken/provider-consul:v0.1.0
```
...
spec:
  package: daanvinken/provider-consul:v0.1.0
EOF
```
