...
export TERRAFORM_PROVIDER_SOURCE ?= hashicorp/consul
export TERRAFORM_PROVIDER_REPO ?= https://github.com/hashicorp/terraform-provider-consul
export TERRAFORM_PROVIDER_VERSION ?= 2.21.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-consul
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-consul_v2.21.0
